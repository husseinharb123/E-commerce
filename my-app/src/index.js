...
import UpdateProductSection from "./Admin/Sections/UpdateProductSection/UpdateProductSection";
        ...
        <Routes>
          ...
          {storeauth.isloggedin &&
            ...
            <Route path="/admin/:id" element={<AdminPageLayout />} >
              ...
              <Route path="products/updateproduct/:id" element={<UpdateProductSection />} />
